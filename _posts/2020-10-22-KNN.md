...
<div class="img-with-text">
    ...
    <p>Decision boundary of nearest neighbors decision on Iris dataset with 3 nearest neighbors</p>
</div>
...
<div class="img-with-text">
    ...
    <p>Find the mode of the labels the new data is closet to.</p>
</div>
...
<div class="img-with-text">
    ...
    <p><a href="https://www.datacamp.com/community/tutorials/machine-learning-in-r"> Machine Learning in R for beginners</a></p>
</div>
